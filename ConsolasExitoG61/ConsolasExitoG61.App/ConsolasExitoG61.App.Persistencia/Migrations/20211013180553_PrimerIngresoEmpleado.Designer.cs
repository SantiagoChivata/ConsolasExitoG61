...
namespace ConsolasExitoG61.App.Persistencia.Migrations
{
    ...
    [Migration("20211013180553_PrimerIngresoEmpleado")]
    partial class PrimerIngresoEmpleado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Proveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Sucursal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Cliente", b =>
                {
                    b.HasBaseType("ConsolasExitoG61.App.Dominio.Entidades.Persona");
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Empleado", b =>
                {
                    b.HasBaseType("ConsolasExitoG61.App.Dominio.Entidades.Persona");
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Consola", b =>
                {
                    b.HasOne("ConsolasExitoG61.App.Dominio.Entidades.Proveedor", "Proveedor")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Factura", b =>
                {
                    b.HasOne("ConsolasExitoG61.App.Dominio.Entidades.Cliente", "Cliente")
                        .WithMany()
            ...
            modelBuilder.Entity("ConsolasExitoG61.App.Dominio.Entidades.Empleado", b =>
                {
                    b.HasOne("ConsolasExitoG61.App.Dominio.Entidades.Sucursal", "Sucursal")
                        .WithMany()
